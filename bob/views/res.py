def togglebar(self):
    ...
    def menu_evogit(self, checked):
        import os
        os.system("cd ~/w_space/git_repository/bob/bob") #  --background-image $HOME/projetos/bob/doc/sky.jpg")
    ...
    def menu_zz(self, checked):
        ...
        """
        import os
        # limpar esta mensagem, colocar um input para escolha e apresentar a saida
    ...
    def msg_construcao(self):
        ...
        popup.setInformativeText("Agradeco a pacitncia.")
        popup.setStandardButtons(QMessageBox.Cancel)
